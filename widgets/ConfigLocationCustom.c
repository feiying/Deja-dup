/* ConfigLocationCustom.c generated by valac 0.16.1, the Vala compiler
 * generated from ConfigLocationCustom.vala, do not modify */
...
static gpointer deja_dup_config_location_custom_parent_class = NULL;
...
enum  {
	DEJA_DUP_CONFIG_LOCATION_CUSTOM_DUMMY_PROPERTY
};
...
static GObject * deja_dup_config_location_custom_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties);
...
DejaDupConfigLocationCustom* deja_dup_config_location_custom_construct (GType object_type, GtkSizeGroup* sg) {
	DejaDupConfigLocationCustom * self = NULL;
	GtkSizeGroup* _tmp0_;
	g_return_val_if_fail (sg != NULL, NULL);
	_tmp0_ = sg;
	self = (DejaDupConfigLocationCustom*) g_object_new (object_type, "label-sizes", _tmp0_, NULL);
	return self;
}


DejaDupConfigLocationCustom* deja_dup_config_location_custom_new (GtkSizeGroup* sg) {
	return deja_dup_config_location_custom_construct (DEJA_DUP_TYPE_CONFIG_LOCATION_CUSTOM, sg);
}
...
static GObject * deja_dup_config_location_custom_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	DejaDupConfigLocationCustom * self;
	DejaDupConfigEntry* _tmp0_;
	DejaDupConfigEntry* _tmp1_;
	DejaDupConfigEntry* entry;
	DejaDupConfigEntry* _tmp2_;
	const gchar* _tmp3_ = NULL;
	DejaDupConfigEntry* _tmp4_;
	parent_class = G_OBJECT_CLASS (deja_dup_config_location_custom_parent_class);
	obj = parent_class->constructor (type, n_construct_properties, construct_properties);
	self = DEJA_DUP_CONFIG_LOCATION_CUSTOM (obj);
	_tmp0_ = deja_dup_config_entry_new (DEJA_DUP_FILE_PATH_KEY, DEJA_DUP_FILE_ROOT);
	_tmp1_ = g_object_ref_sink (_tmp0_);
	entry = _tmp1_;
	_tmp2_ = entry;
	deja_dup_config_entry_set_accessible_name (_tmp2_, "CustomFolder");
	_tmp3_ = _ ("_URI");
	_tmp4_ = entry;
...
static void deja_dup_config_location_custom_class_init (DejaDupConfigLocationCustomClass * klass) {
	deja_dup_config_location_custom_parent_class = g_type_class_peek_parent (klass);
	G_OBJECT_CLASS (klass)->constructor = deja_dup_config_location_custom_constructor;
}


static void deja_dup_config_location_custom_instance_init (DejaDupConfigLocationCustom * self) {
}


GType deja_dup_config_location_custom_get_type (void) {
	static volatile gsize deja_dup_config_location_custom_type_id__volatile = 0;
	if (g_once_init_enter (&deja_dup_config_location_custom_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (DejaDupConfigLocationCustomClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) deja_dup_config_location_custom_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (DejaDupConfigLocationCustom), 0, (GInstanceInitFunc) deja_dup_config_location_custom_instance_init, NULL };
		GType deja_dup_config_location_custom_type_id;
		deja_dup_config_location_custom_type_id = g_type_register_static (DEJA_DUP_TYPE_CONFIG_LOCATION_TABLE, "DejaDupConfigLocationCustom", &g_define_type_info, 0);
		g_once_init_leave (&deja_dup_config_location_custom_type_id__volatile, deja_dup_config_location_custom_type_id);
	}
	return deja_dup_config_location_custom_type_id__volatile;
}
