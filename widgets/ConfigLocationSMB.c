/* ConfigLocationSMB.c generated by valac 0.16.1, the Vala compiler
 * generated from ConfigLocationSMB.vala, do not modify */
...
static gpointer deja_dup_config_location_smb_parent_class = NULL;
...
enum  {
	DEJA_DUP_CONFIG_LOCATION_SMB_DUMMY_PROPERTY
};
...
DejaDupConfigLocationSMB* deja_dup_config_location_smb_construct (GType object_type, GtkSizeGroup* sg) {
	DejaDupConfigLocationSMB * self = NULL;
	GtkSizeGroup* _tmp0_;
	g_return_val_if_fail (sg != NULL, NULL);
	_tmp0_ = sg;
	self = (DejaDupConfigLocationSMB*) g_object_new (object_type, "label-sizes", _tmp0_, NULL);
	return self;
}


DejaDupConfigLocationSMB* deja_dup_config_location_smb_new (GtkSizeGroup* sg) {
	return deja_dup_config_location_smb_construct (DEJA_DUP_TYPE_CONFIG_LOCATION_SMB, sg);
}
...
static void deja_dup_config_location_smb_class_init (DejaDupConfigLocationSMBClass * klass) {
	deja_dup_config_location_smb_parent_class = g_type_class_peek_parent (klass);
	G_OBJECT_CLASS (klass)->constructor = deja_dup_config_location_smb_constructor;
}


static void deja_dup_config_location_smb_instance_init (DejaDupConfigLocationSMB * self) {
}


GType deja_dup_config_location_smb_get_type (void) {
	static volatile gsize deja_dup_config_location_smb_type_id__volatile = 0;
	if (g_once_init_enter (&deja_dup_config_location_smb_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (DejaDupConfigLocationSMBClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) deja_dup_config_location_smb_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (DejaDupConfigLocationSMB), 0, (GInstanceInitFunc) deja_dup_config_location_smb_instance_init, NULL };
		GType deja_dup_config_location_smb_type_id;
		deja_dup_config_location_smb_type_id = g_type_register_static (DEJA_DUP_TYPE_CONFIG_LOCATION_TABLE, "DejaDupConfigLocationSMB", &g_define_type_info, 0);
		g_once_init_leave (&deja_dup_config_location_smb_type_id__volatile, deja_dup_config_location_smb_type_id);
	}
	return deja_dup_config_location_smb_type_id__volatile;
}
