/* ConfigLocationRackspace.c generated by valac 0.16.1, the Vala compiler
 * generated from ConfigLocationRackspace.vala, do not modify */
...
static gpointer deja_dup_config_location_rackspace_parent_class = NULL;
...
enum  {
	DEJA_DUP_CONFIG_LOCATION_RACKSPACE_DUMMY_PROPERTY
};
...
static GObject * deja_dup_config_location_rackspace_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties);
...
DejaDupConfigLocationRackspace* deja_dup_config_location_rackspace_construct (GType object_type, GtkSizeGroup* sg) {
	DejaDupConfigLocationRackspace * self = NULL;
	GtkSizeGroup* _tmp0_;
	g_return_val_if_fail (sg != NULL, NULL);
	_tmp0_ = sg;
	self = (DejaDupConfigLocationRackspace*) g_object_new (object_type, "label-sizes", _tmp0_, NULL);
	return self;
}


DejaDupConfigLocationRackspace* deja_dup_config_location_rackspace_new (GtkSizeGroup* sg) {
	return deja_dup_config_location_rackspace_construct (DEJA_DUP_TYPE_CONFIG_LOCATION_RACKSPACE, sg);
}
...
static GObject * deja_dup_config_location_rackspace_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	DejaDupConfigLocationRackspace * self;
	...
	parent_class = G_OBJECT_CLASS (deja_dup_config_location_rackspace_parent_class);
	obj = parent_class->constructor (type, n_construct_properties, construct_properties);
	self = DEJA_DUP_CONFIG_LOCATION_RACKSPACE (obj);
	_tmp0_ = _ ("_Username");
	_tmp1_ = deja_dup_config_entry_new (DEJA_DUP_RACKSPACE_USERNAME_KEY, DEJA_DUP_RACKSPACE_ROOT);
	_tmp2_ = g_object_ref_sink (_tmp1_);
	deja_dup_config_location_table_add_widget ((DejaDupConfigLocationTable*) self, _tmp0_, (GtkWidget*) _tmp2_, NULL, NULL);
	_g_object_unref0 (_tmp2_);
	_tmp3_ = _ ("_Container");
	_tmp4_ = deja_dup_config_folder_new (DEJA_DUP_RACKSPACE_CONTAINER_KEY, DEJA_DUP_RACKSPACE_ROOT);
...
static void deja_dup_config_location_rackspace_class_init (DejaDupConfigLocationRackspaceClass * klass) {
	deja_dup_config_location_rackspace_parent_class = g_type_class_peek_parent (klass);
	G_OBJECT_CLASS (klass)->constructor = deja_dup_config_location_rackspace_constructor;
}


static void deja_dup_config_location_rackspace_instance_init (DejaDupConfigLocationRackspace * self) {
}


GType deja_dup_config_location_rackspace_get_type (void) {
	static volatile gsize deja_dup_config_location_rackspace_type_id__volatile = 0;
	if (g_once_init_enter (&deja_dup_config_location_rackspace_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (DejaDupConfigLocationRackspaceClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) deja_dup_config_location_rackspace_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (DejaDupConfigLocationRackspace), 0, (GInstanceInitFunc) deja_dup_config_location_rackspace_instance_init, NULL };
		GType deja_dup_config_location_rackspace_type_id;
		deja_dup_config_location_rackspace_type_id = g_type_register_static (DEJA_DUP_TYPE_CONFIG_LOCATION_TABLE, "DejaDupConfigLocationRackspace", &g_define_type_info, 0);
		g_once_init_leave (&deja_dup_config_location_rackspace_type_id__volatile, deja_dup_config_location_rackspace_type_id);
	}
	return deja_dup_config_location_rackspace_type_id__volatile;
}
